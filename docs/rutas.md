...
| -- | -- | -- | -- | -- |
| PUT | /asignaturas/:asig/valoraciones | [HU12][hu12] | Crear asignatura para valorar | `CrearAsignatura` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturas/:asig/valoraciones | [HU2][hu2] | Obtener valoraciones de una asignatura | `GetValoraciones` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| POST | /asignaturas/:asig/valoraciones/:val | [HU1][hu1]  | Añadir valoración a una asignatura | `Valorar` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturaspeorvalorada | [HU10][hu10] | Obtener asignatura peor valorada | `GetPeor` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturasmejorvalorada | [HU11][hu11] | Obtener asignatura mejor valorada | `GetMejor` 
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturas/:asig/valoraciones/media | [HU3][hu3] | Obtener valoración media de una asignatura | `GetMedia` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| PUT | /asignaturas/:asig/resenias | [HU13][hu13] | Crear una asignatura para reseñar | `CrearAsignatura` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturas/:asig/resenias | [HU5][hu5] | Ver reseñas de una asignatura | `GetResenias` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturas/:asig/resenias/:id | [HU14][hu14] | Obtener una sola reseña de una asignatura | `GetResenia` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| POST | /asignaturas/:asig/resenias | [HU4][hu4] | Añadir una reseña a una asignatura | `Opinar` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| POST | /asignaturas/:asig/resenias/:id/gusta | [HU6][hu6] | Indicar que una reseña ha gustado | `GustaResenia`|
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| POST | /asignaturas/:asig/resenias/:id/nogusta | [HU6][hu6] | Indicar que una reseña no ha gustado | `NoGustaResenia` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| PUT | /asignaturas/:asig/preguntas | [HU15][hu15] | Crear asignatura para preguntar | `CrearAsignatura` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturas/:asig/preguntas | [HU8][hu8] | Obtener preguntas de una asignatura | `GetPreguntas` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| GET | /asignaturas/:asig/preguntas/:id | [HU16][hu16] | Obtener una pregunta de una asignatura | `GetPregunta` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| POST | /asignaturas/:asig/preguntas | [HU7][hu7] | Añadir una pregunta a una asignatura | `Preguntar` |
...
| ORDEN | RUTA | HU | DESCRIPCIÓN | FUNCIÓN | 
| -- | -- | -- | -- | -- |
| POST | /asignaturas/:asig/preguntas/:id | [HU9][hu9] | Añadir una respuesta a una pregunta de una asignatura | `Responder` |
